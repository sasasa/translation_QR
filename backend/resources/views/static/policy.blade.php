...
<div id="policy">
  <h1>プライバシーポリシー</h1>
  <p>{{$companyName}}
  （以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
  ...
  <h2>第10条（お問い合わせ窓口）</h2>
  <ul>
    <li>社名：{{$companyName}}</li>
    <li>住所：{{$companyAddress}}</li>
    <li>電話：{{$tel}}</li>
  </ul>
</div>
