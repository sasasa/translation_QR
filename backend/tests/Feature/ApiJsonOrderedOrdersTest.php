...
class ApiJsonOrderedOrdersTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_json_ordered_orders()
    {
        $seat = new \App\Seat([
            'seat_name' => 'S1',
            'seat_state' => 'empty',
        ...
        $response = $this->json('POST', '/api/json_ordered_orders', [
        ...
        $response->
            assertStatus(200)->
            assertJson([
                'ordered_orders' => $session->orders->toArray(),
            ]);
    }
}
